...
namespace Utility
{
    ...
    public class IniFile
    {
        ...
        {
            if (sectionName == null)
                throw new MyAppException(String.Format("{0} is null", sectionName, new ArgumentNullException()));

            if (keyName == null)
                throw new MyAppException(String.Format("{0} is null", keyName, new ArgumentNullException()));
        ...
        public void WriteValue(string sectionName, string keyName, string value)
        {
            ...
            if (value == null)
                throw new MyAppException(String.Format("{0} is null", value, new ArgumentNullException()));
